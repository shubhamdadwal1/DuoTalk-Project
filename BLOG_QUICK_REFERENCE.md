...
### Get All Blogs
```
GET http://3.25.222.207:3001/api/blogs
Response: [{ _id, title, content, tags, author, likes, createdAt, ... }]
```

### Create Blog
```
POST http://3.25.222.207:3001/api/blogs
Body: {
  title: string,
  content: string,
  tags: [string],
...
### Like Blog
```
POST http://3.25.222.207:3001/api/blogs/:blogId/like
...
```
GET http://3.25.222.207:3001/api/blogs/user/user-firebase-uid
```
...
3. **API URL**: `http://3.25.222.207:3001`
...
1. **Start Backend**:
   ...
   cd backend
   npm start
   # Server runs on http://3.25.222.207:3001
   ```

...
- **Backend API:** http://54.206.28.179:3001
- **MongoDB Admin:** http://localhost:8081 (optional, use `docker-compose --profile admin up`)
- **Socket.IO:** Connects via frontend to http://54.206.28.179:3001
...
fetch('http://54.206.28.179:3001/api/health')
  .then(r => r.json())
  .then(console.log)
```
...
3. ✅ Socket URL defaults to `http://54.206.28.179:3001`
